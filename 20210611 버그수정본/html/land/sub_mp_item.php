                                ...
                                <div class="info l-inline">
                                    ...
                                    <ul class="info-meta">
                                        ...
                                        <li>
                                            ...
                                            <!--                                                <em class="value"><i-->
                                            <!--                                                            class="unit">&#8361;&nbsp;</i>-->
                                            <?php //echo number_format($row_land['land_register_price']) ?><!--</em>-->
                                            <!--                                            </span>-->
                                            <!--                                        </li>-->
                                        <li class="tel">
                                            <span class="wrap">
                        ...
                        <?php if ($row_land['land_free_analysis_status'] == 2) { ?>
                            ...
                            <section class="rg-datas">
                                ...
                                <div class="link-wrap clear">
                                    <a href="https://www.eum.go.kr/web/am/amMain.jsp"
                                       class="btn_link l-fleft bx-round_l bg_g">토지 이음 바로 가기</a>
                                    <a href="#none" class="btn_more btn_pop l-fright bx-round_l bg_g"
                                       data-popup="inform_use">토지 이음에서 봐야 하는 정보 자세히 보기</a>
                                </div>
                                <div class="txt-wrap">
                                    <p class="txt">
            ...
            IMP.request_pay({
                ...
                if (rsp.success) {
                    ...
                    $.ajax({
                        ...
                        , data: {
                            pg_pay_id: merchant_uid,
                            pg_service_type: service_type,
                            pg_pay_type: pg_radio,
                            pg_service_price: service_price,
                            pg_user_email: user_email
                            ,
                            pg_user_name: user_name,
