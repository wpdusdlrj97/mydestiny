...
<div id="contents_box">
    <div id="main_contents_box">
        <div id="main_contents_box_place">
            ...
            <div id="main_contents_box_place_title">공지사항 작성</div>
            ...
            <div id="main_contents_box_place_content_right">
                <div id="main_contents_box_place_content_right_title_box">
                    <input type="text" id="main_contents_box_place_content_right_title_input" placeholder="공지사항 제목을 입력해주세요 (50자 이내)" maxlength="50">
                </div>
                <div id="main_contents_box_place_content_right_target_box">
                    <select id="main_contents_box_place_content_right_target_input" id="notice_target">
                ...
                <div id="main_contents_box_place_content_right_content_box">
                    <textarea id="main_contents_box_place_content_right_content_input" placeholder="공지사항 내용을 입력해주세요"></textarea>
                </div>
            </div>
            <div class="black_button"  onclick="history.back()">이전</div>
            <div class="white_button" onclick="notice_write()">작성완료</div>
        </div>
    </div>
</div>
...
<script>
    ...
    function notice_write(){
        ...
        var notice_target = $("#main_contents_box_place_content_right_target_input option:selected").text();
        ...
        if(notice_title==''){
            ...
            $.ajax({
                ...
                ,data: {type:"write",title:notice_title,target:notice_target,content:notice_content}
                ,success:function(result){
                    if(result=='success'){
                        alert("공지사항을 업로드하였습니다");
