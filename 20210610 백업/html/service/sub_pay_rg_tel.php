                ...
                <div class="container service-box">
                    <div class="inner">
                        <div class="title-wrap">
                            ...
                            <p class="desc">
                                <span>분석 받고 싶은 토지의 주소지는 알고 있는데 어떻게 운영 할지 모르겠다면?</span>
                                <br>
                                <span>랜드마킹이 토지를 대신 등록해 최상의 컨디션 운영 되도록 도와드립니다!</span>
                            </p>
                            <div class="img_area">
...
<script>
    ...
    var merchant_uid = 'merchant_rg_tel' + new Date().getTime();
    var service_type = '<?php echo '3'?>';
