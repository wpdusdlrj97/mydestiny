                                                ...
                                                <div class="inner">
                                                    <div class="wrap ">
                                                        ...
                                                        <div class="item btns l-inlinebox">
                                                            ...
                                                            <span class="btn status l-inlinebox bx-round_l bg_n" style="cursor:pointer;"onclick="location.href='https://landmarking.co.kr/html/mypage/sub_mp_faq_modify.php?id=<?php echo $qna_id[$x] ?>'">수정하기</span>
