...
$faq_number = $_GET['faq_number'];

$qry_string = "SELECT * FROM faq where faq_number='$faq_number'";
...
<div id="contents_box">
    <div id="main_contents_box">
        <div id="main_contents_box_place">
            ...
            <div id="main_contents_box_place_title">자주묻는질문 상세보기</div>
            ...
            <div id="main_contents_box_place_content_right">
                <div id="main_contents_box_place_content_right_title_box">
                    <input type="text" id="main_contents_box_place_content_right_title_input" maxlength="50" value="<?php echo $row['faq_title'];?>" readonly>
                </div>
                <div id="main_contents_box_place_content_right_target_box">
                    ...
                    <select id="main_contents_box_place_content_right_target_select" id="user_list_search">
                        <?php if($row['faq_target']=='0'){ ?>
                            <option selected>전체</option>
                            <option>사용자</option>
                            <option>상담가</option>
                        <?php }else if($row['faq_target']=='1'){  ?>
                            <option>전체</option>
                ...
                <div id="main_contents_box_place_content_right_content_box">
                    <textarea id="main_contents_box_place_content_right_content_input" readonly><?php echo $row['faq_content'];?> </textarea>
                </div>
            </div>

            <div class="black_button" onclick="history.back()">목록</div>
            <div class="white_button" id="delete_button" onclick="faq_delete();">삭제하기</div>
            <div class="white_button" id="modify_button" onclick="faq_modify();">수정하기</div>
            <div class="black_button_hide" id="modify_finish_button" onclick="faq_modify_finish();">수정완료</div>
...
<script>
    ...
    function faq_delete(){
        ...
        var faq_number = '<?php echo $faq_number;?>';
        ...
        if(result){
            ...
            $.ajax({
                ...
                ,data: {type:"delete", number:faq_number}
                ,success:function(result){
                    if(result=='success'){
                        alert("자주묻는질문을 삭제하였습니다");
    ...
    function faq_modify_finish(){


        var faq_title= $("#main_contents_box_place_content_right_title_input").val();
        var faq_target = $("#main_contents_box_place_content_right_target_select option:selected").text();
        var faq_content = $("#main_contents_box_place_content_right_content_input").val();
        var faq_number = '<?php echo $faq_number;?>';

        // alert(faq_title+'/'+faq_target+'/'+faq_content+'/'+faq_number);
        ...
        if(faq_title==''){
            ...
            $.ajax({
                type: "POST"
                ,url: "/admin/server/faq_server.php"
                ,data: {type:"modify",title:faq_title,target:faq_target,content:faq_content, number:faq_number}
                ,success:function(result){
                    if(result=='success'){
                        alert("자주묻는질문을 수정하였습니다");
                        location.href='/admin/theme/cs/faq_detail.php?faq_number=<?php echo $faq_number;?>';
                    }else{
