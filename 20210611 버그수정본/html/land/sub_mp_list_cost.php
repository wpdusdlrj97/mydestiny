...
if (!$user_session) {
    ...
    $qry_string = "SELECT * FROM land_information where land_register_id='$user_session' and land_cost_analysis_status='2' ORDER BY land_register_date DESC";
                    ...
                    <div class="inner">
                        <div class="tit">
                            ...
                            <h2 class="tit-wrap l-inlinebox">
                                ...
                                <a href="./sub_mp_list_all.php" class="tit ft_b">내 토지</a>
                            </h2>
                    ...
                    <div class="inner">
                        <div class="mylist-tab">
                            <div class="wrap clear">
                                ...
                                <a class="tit_txt on" href="#">전문 분석 완료</a>
                                                    ...
                                                    <div class="wrap ">
                                                        ...
                                                        <div class="item btns l-inlinebox">
                                                            <span class="btn status l-inlinebox bx-round_l bg_n"
                                                                  style="background-color: #000000 ">무료 분석 요청하기</span>
                                                            <i class="btn btn_more btn_pop bx-round_l bg_v"
                                                               data-popup="service_an_small">전문
                                                                분석 요청하기</i>
                                                        </div>
                                            ...
                                            <li class="bx-round_l">
                                                <a href="./sub_mp_item.php?land_id=<?php echo $land_id[$x];?>" class="inner">
                                                    <div class="wrap ">
                                                        ...
                                                        <div class="item btns l-inlinebox">
                                                            <span class="btn status l-inlinebox bx-round_l bg_n">무료 분석 대기중</span>
                                                            <i class="btn btn_more btn_pop bx-round_l bg_v"
                                                               data-popup="service_an_small">전문
                                                                분석 요청하기</i>
                                                        </div>
                                        ...
                                        <li class="bx-round_l pro-analysized">
                                            <a href="./sub_mp_item.php?land_id=<?php echo $land_id[$x];?>" class="inner">
                                                <div class="wrap ">
                                                    ...
                                                    <div class="item btns l-inlinebox">
                                                        <span class="btn status l-inlinebox bx-round_l bg_n">무료 분석 대기중</span>
                                                        <i class="btn btn_more bx-round_l bg_v" style="background-color: #0000001A">전문 분석을 진행중입니다!</i>
                                                    </div>
                                                    <div class="item content l-inlinebox">
                                                        <div class="wrap">
                                                            <p class="title">
                        ...
                        <div class="pagination l-fleft">
                            <?php if ($page > 0) { ?>
                                <button class="btn btn_prev" type="button"
                                        onclick="location.href='sub_mp_list_cost.php?page=<?php echo $page - 1 ?>'"></button>
                            <?php } ?>
                            <div class="wrap">
                                <?php
                                if ($all_count > 0) {
                                    for ($x = ((int)($page / 5) * 5); $x < ((int)($page / 5) * 5) + 5; $x++) {
                                        if ($x == $page) { ?>
                                            <a class="btn bx-round_xs page_num on"
                                               onclick="location.href='sub_mp_list_cost.php?page=<?php echo $x ?>'"><?php echo $x + 1 ?></a>
                                        <?php } else { ?>
