                            ...
                            <form>
                                <fieldset class="select-box is-id">
                                    ...
                                    <div class="options">
                                        ...
                                        <span class="option" data-option="탈퇴일">탈퇴일</span>
                                    </div>
                                </fieldset>
                            ...
                            <table class="table">
                                <thead class="thead">
                                    <tr class= "tr">
                                        ...
                                        <th class="th t-date t-date_join">회원가입일</th>
                                        <th class="th t-date t-date_unsub">탈퇴일</th>
                                    </tr>
                                </thead>
                                <tbody class="tbody">
                                    <tr class="tr">
                                        ...
                                        <td class="td t-tel"><span class="value">010-1234-5678</span></td>
                                        <td class="td t-date t-date_join"><span class="value">2021.01.01</span></td>
                                        <td class="td t-date t-date_unsub"><span class="value">2021.01.01</span></td>
                                    </tr>
                                    <tr class="tr">
