...
if (!$admin_session) {
    ...
    if($filter_service_status=='1'){ //대기중
        $qry_string = "SELECT * FROM pay_information where service_type NOT IN ('0') and service_status='1'";

    }else if($filter_service_status=='2'){ //진행중
        $qry_string = "SELECT * FROM pay_information where service_type NOT IN ('0') and service_status='2'";

    }else if($filter_service_status=='3'){  //완료
        $qry_string = "SELECT * FROM pay_information where service_type NOT IN ('0') and service_status='3'";

    }else{ //전체
        $qry_string = "SELECT * FROM pay_information where service_type NOT IN ('0')";
    }


    //결제 상품
    if($filter_service=='an_tel'){ // 전화분석
