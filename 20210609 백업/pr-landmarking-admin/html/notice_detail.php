                        ...
                        <div class="form-wrap wide">
                            <form>
                                <fieldset>
                                    ...
                                    <input type="text" class="notice-tit" value="공지사항입니다.">
                                </fieldset>
                                <fieldset>
                                    <legend class="legend">내용</legend>
                                    <textarea name="quest" class="notice-cont" cols="60" rows="30" required>공지사항 본문 입니다.</textarea>
                                </fieldset>
                                ...
                                <div class="btn-wrap">
                                    ...
                                    <button type="button" class="btn btn_sm">수정 등록</button>
                                </div>
                            </form>
                        </div>
                    </div>
