...
if (!$admin_session) {
    ...
    <div id="wrapper">
        <div class="popup popup-mypage">
            <div class="container">
                <div class="inner">
                    <div class="title">일반회원 비밀번호 수정</div>
                    <div class="form-wrap">
    ...
    <script>
        ...
        function change_pw() {
            ...
            var update_email= '<?php echo $user_id?>';
            ...
            if(update_pw==''){
                ...
                $.ajax({
                    type: "POST"
                    ,url: "/admin_server/user_pw_change_server.php"
                    ,data: {type:'user',email:update_email,pw:update_pw}
