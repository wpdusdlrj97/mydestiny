...
if (!$user_session) {
                    ...
                    <div class="inner">
                        <div class="tit clear">
                            ...
                            <h2 class="tit-wrap l-inlinebox">
                                ...
                                <span class="tit ft_b on">문의 수정하기</span>
                            </h2>
                        </div>
                    </div>
                </div>
                            ...
                            <form class="ft_m_l" onsubmit="return false;">
                                <fieldset>
                                    <div class="form-wrap bx-round_l bg_g">
                                        ...
                                        <div class="input-wrap bx-round_s">
                                            <input type="text" id="qna_title" name="qna_title" maxlength="49"
                                                   ...
                                                   value="<?php echo $row_qna['qna_title']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-wrap form-wrap_t bx-round_l bg_g">
                                        ...
                                        <div class="input-wrap bx-round_s ">
                                            <textarea id="qna_content" name="qna_content" rows="50" cols="30"
                                                      placeholder="내용을 입력해주세요"><?php echo $row_qna['qna_content']; ?></textarea>
                                        </div>
                                    </div>


                                    <div class="form-wrap form-wrap_f clear bx-round_l">
                                        <?php if ($row_qna['qna_main_image'] == null || $row_qna['qna_main_image'] == '') { ?>

                                            <span class="tit" id="old_main_image_text">기존 대표 이미지가 존재하지 않습니다 </span>

                                        <?php } else { ?>
                                            <span class="tit" id="old_main_image_text">기존 대표 이미지 </span>
                                            <div id="old_main_image">
                                                <img src="<?php echo $row_qna['qna_main_image'] ?>"
                                                     style="width: 100px; height: 100px; margin-right: 20px; border: 4px solid #7868E6">
                                            ...
                                            $qna_sub_image_list_array = json_decode($row_qna['qna_sub_image_list']);

                                            if ($row_qna['qna_sub_image_list'] == null) {
                                                ...
                                                <div>
                                                    ...
                                                    for ($i = 0; $i < count($qna_sub_image_list_array); $i++) {
                                                        ...
                                                        <div style="position : relative; margin-right:15px;width: 100px;height: 100px;float: left;">
                                                            <img src="<?php echo $qna_sub_image_list_array[$i] ?>"
                                                                 width="100" height="100"/>
                                                            <button class="sub_image_delete"
                                                                    style="position: absolute; left:80px; background-color:#7868E6; color: white; width: 20px; height: 20px;"
                                                                    type="button">x
                                                            </button>
                                                        </div>
                                                    <?php } ?>
                                    ...
                                    <div class="form-wrap form-wrap_f clear bx-round_l bg_g">
                                        ...
                                        <label for="thumbnail" class="btn btn_thumb bg_v bx-round_l">변경하기</label>
                                    ...
                                    <button class="btn btn_sm bx-round_l bg_v" onclick="qna_update()"> 수정 완료</button>
                                </fieldset>
                            </form>
                            <!--                            <button class="btn btn_sm bx-round_l bg_v" onclick="qna_update()"> 문의 등록 하기</button>-->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        var old_sub_image_list_array = <?php echo json_encode($qna_sub_image_list_array); ?>;
    ...
    <script>
        function qna_update() {
            ...
            if (qna_title == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "/server/qna_modify_server.php",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function (result) {
                        ...
                        if (result == 'success') {
                            alert("문의 수정을 완료했습니다");
                            location.href = 'https://landmarking.co.kr/html/mypage/sub_mp_faq_all.php';
                        } else {
