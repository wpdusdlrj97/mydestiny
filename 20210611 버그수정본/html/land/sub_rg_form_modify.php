...
if (!$user_session) {
    ...
    <div id="wrap" class="sub sub-register">
        ...
        <main id="main">
                    ...
                    <div class="inner">
                        <div class="tit">
                            ...
                            <h2 class="tit-wrap l-inlinebox">
                                <a href="#" class="tit ft_b">토지수정</a>
                                <span class="tit ft_b"><span
                                            class="addr"><?php echo $row_land['land_address']; ?></span></span>
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="main-content">
                <div class="container">
                    <div class="inner">
                        <div class="rg-inform_txt"><span class="addr"><?php echo $row_land['land_address']; ?></span>등록하기
                        </div>
                        <div class="rg-inform bx-round_l bg_n">
                            <div class="wrap">
                                <img src="../../images/sub/icon_MapPinLine.png" alt="check icon">
                                <span><?php echo $row_land['land_address']; ?></span>
                            </div>
                        </div>
                        <div id="map" style="margin-bottom:40px; width: 100%; height: 500px;border-radius: 10px;"></div>
                        <div class="rg-link bx-round_l bg_g"
                             style="width:100%; height:240px; margin-bottom: 50px; text-align:center">토지 이음 링크 & 관련 설명
                        </div>
                            ...
                            <form class="ft_m_l" onsubmit="return false;">
                                <fieldset class="clear">
                                    ...
                                    <div class="form-wrap bx-round_l">
                                        <label for="name" class="tit clear">성명<span
                                                    class="check">공인중개사는 꼭 실명을 기입해 주세요.</span> </label>
                                    ...
                                    <div class="form-wrap bx-round_l">
                                        ...
                                        <div class="input-wrap bx-round_s">
                                            <input type="number" id="land_phone" maxlength="11"
                                    ...
                                    <div class="form-wrap bx-round_l">
                                        ...
                                        <div class="input-wrap bx-round_s">
                                            <input type="text" id="land_title" maxlength="50" placeholder="제목을 입력해주세요"
                                                   value="<?php echo $row_land['land_register_title']; ?>">
                                            <span class="cnt"><em class="value">0</em> / <em>50</em></span>
                                        </div>
                                    </div>
                                    <div class="col-wrap clear">
                                        <div class="form-wrap bx-round_l">
                                            ...
                                            <div class="input-wrap bx-round_s">
                                                <input type="number" id="land_area" maxlength="50"
                                                       placeholder="'제곱미터'단위로 입력해주세요"
                                        ...
                                        <div class="form-wrap bx-round_l l-fright">
                                            ...
                                            <div class="input-wrap bx-round_price">
                                                <input type="number" id="land_price" maxlength="50"
                                    ...
                                    <div class="form-wrap form-wrap_t bx-round_l">
                                        ...
                                        <div class="input-wrap bx-round_s ">
                                            <textarea id="land_content" rows="50" cols="30"
                                                      placeholder="내용을 입력해주세요"><?php echo strip_tags($row_land['land_register_content']); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-wrap form-wrap_f clear bx-round_l">
                                        <span class="tit" id="old_main_image_text">기존 대표 이미지 </span>
                                        <div id="old_main_image">
                                            <img src="<?php echo $row_land['land_main_image'] ?>" style="width: 100px; height: 100px; margin-right: 20px; border: 4px solid #7868E6">
                                             ...
                                             if ($row_land['land_sub_image_list'] == null ) {

                                            } else { ?>

                                            <span class="tit">기존 참고 이미지 </span>
                                            <div>
                                                <?php
                                    ...
                                    <div class="form-wrap form-wrap_f clear bx-round_l">
                                        ...
                                        <label for="thumbnail" class="btn btn_thumb bx-round_l">변경<span
                                                    class="pc">하기</span></label>
                                    ...
                                    <button class="btn btn_sm bx-round_l bg_v" onclick="land_register()"> 수정하기</button>
                                    <a href="#" class="btn btn_del" onclick="rg_back()">취소하기</a>
                                </fieldset>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        function registerFormFileFn() {
            ...
            $thumbInput.on('change', function (event) {
                ...
                //기존 이미지 삭제
                $('#old_main_image_text').remove();
                $('#old_main_image').remove();
    ...
    <script>
        function land_register() {
            ...
            var land_area_number = Number(land_area);
            var land_price_number = Number(land_price);
            ...
            if (land_name == '') {
                ...
                alert('토지 면적을 입력해주세요')
            } else if (land_area_number > 90000000 || land_area_number < 1) {
                alert('토지 면적을 정확히 입력해주세요')
            } else if (land_price == '') {
                alert('토지 가격을 입력해주세요')
            } else if (land_price_number > 9000000000000 || land_price_number < 1) {
                ...
                console.log(land_id + "/"  + land_name + "/" + land_phone + "/" + land_title + "/" + land_area + "/" + land_price + "/" + land_content);
                ...
                $.ajax({
                    type:"POST",
                    url:"/server/land_modify_server.php",
                    data:formData,
                    cache:false,
                    contentType:false,
                    processData:false,
                    ...
                    success:function(result){
                        ...
                        if(result=='success'){
                            alert("토지 수정을 완료했습니다");
                            location.href='<?php echo $land_url."/html/land/sub_mp_item.php?land_id=".$land_id;?>';
        ...
        function rg_back() {
            if (confirm("취소하시고 이전 페이지로 가시겠습니까?")) { //예 클릭시
                history.back();
            } else {  //아니오 클릭시
            }
        }
