                        ...
                        <div class="form-wrap">
                            <form>
                                ...
                                <div class="wrap">
                                    ...
                                    <input type="text" name="userId" id="userId" required placeholder="입력필수">
                                    <button class="btn btn_check">중복확인</button>
                                </div>
                                <div class="wrap">
                                    <label for="userPwd">비밀번호</label>
                                    <input type="text" name="userPwd" id="userPwd" required placeholder="입력필수">                                
                                </div>
                                <div class="wrap">
                                ...
                                <div class="wrap">
                                    ...
                                    <input type="text" name="userName" id="userName" required placeholder="반드시 실명으로 입력해 주세요">
                                </div>
                                <div class="wrap">
