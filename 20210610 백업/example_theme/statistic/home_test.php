...
if($graph_counsel=='day'){
    ...
    for($i=9; $i>=0; $i=$i-1)
    {
        ...
        //상담  수
        $qry_string_counsel_code_day = "SELECT * FROM counsel_code_test where counsel_code_test_date like '$counsel_code_day%'";
    ...
    for($i=6; $i>=0; $i=$i-1)
    {
        ...
        //상담  수
        $qry_string_counsel_code_month = "SELECT * FROM counsel_code_test where counsel_code_test_date like '$counsel_code_month%'";
    ...
    for($i=0; $i<=4; $i=$i+1)
    {
        ...
        //상담 수
        $qry_string_counsel_code_year = "SELECT * FROM counsel_code_test where counsel_code_test_date like '$counsel_code_year%'";
...
if($graph_user=='day'){
    ...
    for($i=6; $i>=0; $i=$i-1)
    {
        ...
        //가입 수
        $qry_string_user_day = "SELECT * FROM user_test where user_test_date like '$user_day%'";
    ...
    for($i=6; $i>=0; $i=$i-1)
    {
        ...
        //가입 수
        $qry_string_user_month = "SELECT * FROM user_test where user_test_date like '$user_month%'";
    ...
    for($i=0; $i<=4; $i=$i+1)
    {
        ...
        //가입 수
        $qry_string_user_year = "SELECT * FROM user_test where user_test_date like '$user_year%'";
...
if($graph_dosa=='day'){
    ...
    for($i=6; $i>=0; $i=$i-1)
    {
        ...
        //가입 수
        $qry_string_dosa_day = "SELECT * FROM dosa_test where dosa_test_date like '$dosa_day%'";
    ...
    for($i=6; $i>=0; $i=$i-1)
    {
        ...
        //가입 수
        $qry_string_dosa_month = "SELECT * FROM dosa_test where dosa_test_date like '$dosa_month%'";
    ...
    for($i=0; $i<=4; $i=$i+1)
    {
        ...
        //가입 수
        $qry_string_dosa_year = "SELECT * FROM dosa_test where dosa_test_date like '$dosa_year%'";
...
<script>
    ...
    function counsel_graph_change() {
        ...
        if (counsel_count_status == '일간 상담 수') {
            //alert('일간 상담 수');
            location.href = "home_test.php?graph_counsel=day&graph_user=<?php echo $graph_user?>"+"&graph_dosa=<?php echo $graph_dosa?>";
        } else if (counsel_count_status == '월간 상담 수') {
            //alert('월간 상담 수');
            location.href ="home_test.php?graph_counsel=month&graph_user=<?php echo $graph_user?>"+"&graph_dosa=<?php echo $graph_dosa?>";
        } else {
            //alert('연간 상담 수');
            location.href = "home_test.php?graph_counsel=year&graph_user=<?php echo $graph_user?>"+"&graph_dosa=<?php echo $graph_dosa?>";
        }
    }
    ...
    function user_graph_change() {
        ...
        if (user_count_status == '일간 가입 수') {
            //alert('일간 가입 수(사용자)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=day&graph_dosa=<?php echo $graph_dosa?>";
        } else if (user_count_status == '월간 가입 수') {
            //alert('월간 가입 수(사용자)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=month&graph_dosa=<?php echo $graph_dosa?>";
        } else {
            //alert('연간 가입 수(사용자)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=year&graph_dosa=<?php echo $graph_dosa?>";
        }
    }
    ...
    function dosa_graph_change() {
        ...
        if (dosa_count_status == '일간 가입 수') {
            //alert('일간 가입 수(상담가)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=<?php echo $graph_user?>&graph_dosa=day";
        } else if (dosa_count_status == '월간 가입 수') {
            //alert('월간 가입 수(상담가)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=<?php echo $graph_user?>&graph_dosa=month";
        } else {
            //alert('연간 가입 수(상담가)');
            location.href = "home_test.php?graph_counsel=<?php echo $graph_counsel?>"+"&graph_user=<?php echo $graph_user?>&graph_dosa=year";
        }
    }
