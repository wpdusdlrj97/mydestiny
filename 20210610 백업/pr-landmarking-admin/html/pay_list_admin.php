                    ...
                    <div class="contents has-pg clear">
                            ...
                            <form>
                                ...
                                <fieldset class="select-box is-sort">
                                    ...
                                    <div class="options">
                                        ...
                                        <span class="option" data-option="등록대행">등록대행</span>
                                ...
                                <fieldset class="select-box">
                                    <input type="text" class="select" value="" onfocus="this.blur();" readonly placeholder="결제유형">
                                    <div class="options">
                                        <span class="option" data-option="모두보기">모두보기</span>
                                ...
                                <fieldset class="select-box">
                                    <input type="text" class="select" value="" onfocus="this.blur();" readonly placeholder="결제상황">
                                    <div class="options">
                                        <span class="option" data-option="모두보기">모두보기</span>
                        ...
                        <div class="table-area l-fright">
                            <table class="table has-select">
                                ...
                                <tbody class="tbody">
                                    <tr class="tr has-link" onClick="window.open('../html/template/popup_pay02.php','pop','width=768, height=450, top=200, left=200');">
                                        ...
                                        <td class="td t-sort"><span class="value">계좌이체</span></td>
                                        <td class="td t-name"><span class="value">등록대행+전화분석</span></td>
                                        <td class="td t-price"><span class="value">300000</span>원</td>
                                    ...
                                    <tr class="tr has-link"  onClick="window.open('../html/template/popup_pay02.php','pop','width=768, height=450, top=200, left=200');">
                                        ...
                                        <td class="td t-id"><span class="value">land1212@naver.com</span></td>
                                        <td class="td t-call"><span class="value">010-0000-0000</span></td>
                                        <td class="td t-sort"><span class="value">신용카드</span></td>
