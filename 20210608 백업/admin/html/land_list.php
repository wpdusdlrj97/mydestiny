                        ...
                        <?php } else { ?>
                            ...
                            <div class="table-area l-fright">
                                <table class="table">
                                    ...
                                    <tbody class="tbody">
                                    <?php for ($x = 0; $x < $count; $x++) { ?>
                                        <tr class="tr has-link" onClick="location.href='/admin/html/land_detail.php'">
                                            ...
                                            <td class="td t-title"><span class="value"><?php echo $land_register_title[$x] ?></span></td>
        ...
        function pay_delete() {
            ...
            if (land_list_delete_string == '') {
                ...
                if (confirm("선택하신 항목을 삭제하시겠습니까?")) { //예 클릭시
                    ...
                    $.ajax({
                        type: "POST"
                        , url: "/admin_server/land_delete_server.php"
