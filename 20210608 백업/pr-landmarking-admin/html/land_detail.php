...
<head>
    ...
    <title>관리자페이지</title>nt="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no">
    <title>관리자페이지</title>
    <!-- STYLE LINK-->
                            ...
                            <form>
                                <fieldset>
                                    ...
                                    <div class="wrap">
                                        ...
                                        <input type="text" name="userId" id="userId" readonly value="land@hanmil.net">
                                    </div>
                                    <div class="wrap">
                                        <label for="userName">성명</label>
                                        <input type="text" name="userName" id="userName" readonly value="김토지">
                                    </div>
                                    <div class="wrap">
                                        <label for="userTel">전화번호</label>
                                        <input type="tel" name="userTel" id="userTel" readonly value="000-0000-0000">
                                    </div>
                                </fieldset>
                                <fieldset>
                                    ...
                                    <div class="wrap">
                                        ...
                                        <input type="text" id="landTitle" value="서울시 마포구 합정동 토지">
                                    </div>
                                    <div class="wrap">
                                        <label for="landSize">면적</label>
                                        <input class="has-unit" type="text" name="landSize" id="landSize" value="113.3">
                                        <i class="unit">m<sup>2</sup></i>
                                    </div>
                                    <div class="wrap">
                                        <label for="landAddr">주소</label>
                                        <input type="text" name="landAddr" id="landAddr" value="서울시 마포구 합정동 000-12">
                                    </div>
                                    <div class="wrap">
                                        <label for="landPrice">가격</label>
                                        <input class="has-unit" type="text" name="landPrice" id="landPrice" value="10억">
                                        <i class="unit">원</i>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <legend class="legend">토지 내용</legend>
                                    <textarea name="text" cols="50" rows="10">토지 내용이 들어갑니다.</textarea>
                                </fieldset>
                                ...
                                <fieldset class="is-master clear">
                                    ...
                                    <input type="checkbox" name="master" id="master" value="master" class="l-fleft" checked>
                                ...
                                <fieldset class="has-checks">
                                    ...
                                    <div class="wrap clear">
                                        <label class="label l-left">개발가능성</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis01" value="4" checked>4
                                    ...
                                    <div class="wrap clear">
                                        <label class="label l-left">도로유무</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis02" value="7" checked>7
                                    ...
                                    <div class="wrap clear">
                                        <label class="label l-left">경사완만</label>
                                        <div class="check-wrap l-fright">
                                            <input class="check" type="radio" name="analysis03" value="1">1
                                            <input class="check" type="radio" name="analysis03" value="2" checked>2
                                    ...
                                    <div class="wrap clear">
                                        <label class="label l-left">개발호재</label>
                                        <div class="check-wrap l-fright">
                                    ...
                                    <div class="wrap clear">
                                        ...
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis05" value="7" checked>7
                                ...
                                <fieldset class="has-checks">
                                    ...
                                    <div class="wrap clear">
                                        <label class="label l-left">개발축 기간</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis06" value="10" checked>10
                                        </div>
                                    </div>
                                    <div class="wrap clear">
                                        <label class="label has-space l-left">수익</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis07" value="5" checked>5
                                ...
                                <fieldset class="has-checks">
                                    <legend class="legend no-letter"></legend>
                                    <div class="wrap clear">
                                        <label class="label l-left">보조축 기간</label>
                                        <div class="check-wrap l-fright">
                                            <input class="check" type="radio" name="analysis06" value="1">1
                                            <input class="check" type="radio" name="analysis06" value="2">2
                                            <input class="check" type="radio" name="analysis06" value="3">3
                                    ...
                                    <div class="wrap clear">
                                        ...
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis09" value="7" checked>7
                                ...
                                <fieldset class="has-checks">
                                    <legend class="legend no-letter"></legend>
                                    <div class="wrap clear">
                                        <label class="label l-left">보전축 기간</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis10" value="10" checked>10
                                        </div>
                                    </div>
                                    <div class="wrap clear">
                                        <label class="label has-space l-left">수익</label>
                                        <div class="check-wrap l-fright">
                                            ...
                                            <input class="check" type="radio" name="analysis11" value="6" checked>6
                                ...
                                <fieldset class="select-box">
                                    ...
                                    <div class="options">
                                        ...
                                        <span class="option" data-option="전문분석 진행중">전문분석 진행중</span>
                                        <span class="option" data-option="전문분석 완료">전문분석 완료</span>
                                    </div>
                                </fieldset>
                                <div class="btn-wrap">
                                    <button type="button" class="btn btn_cancel">취소</button>
                                    <button type="button" class="btn btn_sm">수정 등록하기</button>
                                </div>
                            </form>
                        </div>
                    </div>
