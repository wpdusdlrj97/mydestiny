                    ...
                    <div class="contents has-pg clear">
                        <div class="search-area">
                            <form>
                                ...
                                <fieldset class="select-box is-id">
                                    <input type="text" class="select" value="" readonly placeholder="검색어">
                                    <div class="options">
                            ...
                            <a href="../html/notice_form.php" class="btn btn_more">글쓰기</a>
                        </div>
                        ...
                        <div class="table-area l-fright">
                            <table class="table">
                                ...
                                <tbody class="tbody">
                                    <tr class="tr has-link" onClick="location.href='../html/notice_detail.php'">
                                        <td class="td t-num"><span class="value">5</span></td>
                                        <td class="td t-user"><span class="value">관리자</span></td>
                                        <td class="td t-title"><span class="value">공지사항입니다.</span></td>
